<template>
    <q-page class="flex flex-center fit" style="min-height:100vh; max-width: 500px;">
        <q-card class="q-pa-xl column items-stretch justify-between"
            style="max-width: 600px; width: 90%; border-radius: 30px;">
            ...
            <div class="column q-gutter-md">
                <q-input v-model="name" color="secondary" filled label="First name" dense />
                <q-input v-model="surname" color="secondary" filled label="Last name" dense />
                <q-input v-model="nickname" color="secondary" filled label="Nickname" dense>
            ...
            <div class="column q-gutter-sm q-mt-md">
                ...
                <q-btn label="Already have an account?" color="secondary" flat class="full-width" @click="goToLogin" />
            </div>
